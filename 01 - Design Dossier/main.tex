...
% David Ephraim Vunn (dvunnana@my.fit.edu)
%
% License:
...
\reportauthors{	Braidan Duffy (bduffy2018@my.fit.edu), \\
				Subinita Dey (sdey2021@my.fit.edu), \\
				David Ephraim Vunn (dvunnava2022@my.fit.edu)} % Report authors/group/department, include new lines if needed
...
\rightfootercontent{CUI - Controller Unclassified Information}
