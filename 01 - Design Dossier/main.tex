...
\include{chapters/1-project_purpose}
\include{chapters/2-stakeholders}
\include{chapters/3-stakeholders_reqs_needs.tex}
\include{chapters/4-Concept_of_operations.tex}
\include{chapters/5-Scope.tex}
\include{chapters/6-Goals and Objectives.tex}
%----------------------------------------------------------------------------------------
